...
export default function New() {
  ...
  const options = [
    { value: 'T002-Mahmud Derawan', label: 'T002-Mahmud Derawan' },
    // { value: 'f', label: 'f'},
        ...
        <main className={styles.mainContent}>
          <div className={styles.content}>
            <div class="d-flex justify-content-start ms-4">
              ...
              <div className={`${styles["select-employee"]} ms-5 mt-4`}>
                <div className={`input-group mt-3 border-none`}>
                  {/* <input
                    type="text"
                    id="new"
            ...
            >
             <button
                  href="./Loan/BtnNew"
                  className={`${styles["btn-save"]} btn btn btn-light border`}
                >
                  save
                </button>
            </div>
