...
import ErrorAlert from "../Component/errorMessage";
...
export async function getServerSideProps(){
  ...
  var bearer= "Bearer "
  var accessToken= "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2MmZiNWY4MGYxMmE3ZDNiYTc2M2QzYjAiLCJlbWFpbCI6ImhlbmRyaXlhbnRvNzI1QGdtYWlsLmNvbSIsImNvbXBhbnkiOiI2MmZiNDZlNjdhOWE0ZDllMWM0NDgwYzciLCJpYXQiOjE2NzA0OTE2MzQsImV4cCI6MTY3MDUwOTYzNH0.SGBmonnn21rRqgjtQhAi3-2t7_vstXm0fa1inuEPKmU"
  ...
  //     // redirect: {
  //     //   permanent :false,
  //     //   destination : "/Component/errorMessage"
  //     // }
  //     props:(res.send(<ErrorAlert
  //     />))
  //   }
